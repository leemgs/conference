...
(function () {
  ...
  window.I18N = {
    ...
    "dash.month.aria": {
      ko: "{year}년 {monthLabel}: 마감 {count}건 (학회 {confCount}곳)",
      en: "{monthLabel} {year}: {count} deadlines ({confCount} conferences)",
    },
    "dash.month.tip.deadlines": { ko: "논문·초록 마감", en: "Paper/abstract deadlines" },
